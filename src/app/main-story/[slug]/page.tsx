...
// function testimonialToDetail(item: PageTestimonial): MainStoryPostDetail {
//   const meta = getRoleMeta(item.role || '');

//   return {
//     title: item.author || 'Main Story',
//     author: meta.author,
//     date: meta.date,
...
// export default function MainStoryDetailPage() {
//   const params = useParams<{ slug: string }>();
//   const slug = params.slug;

//   const [post, setPost] = useState<MainStoryPostDetail | null>(null);
...
//           return generateSlug(item.author || 'Main Story') === slug;
//         });
...
//         }
//       } catch (error) {
//         console.error('Failed to load main story post:', error);
...
//       <main className="cio-detail-page">
//         <div className="cio-detail-container">
//           <Link href="/main-story" className="cio-detail-back">
//             <ArrowLeft size={18} />
//             Back to Main Story
//           </Link>
...
//               <span className="cio-detail-category">MAIN STORY</span>
    ...
    async function loadPost() {
      try {
        ...
        const found = testimonials.find(
          (item: PageTestimonial) => generateSlug(item.author || 'Main Story') === slug,
        );
