...
//   return {
//     title: item.author || 'Thought Leadership',
//     author: meta.author,
//     date: meta.date,
...
// export default function ThoughtLeadershipDetailPage() {
...
//           return generateSlug(item.author || 'Thought Leadership') === slug;
//         });
...
//       <main className="cio-detail-page">
//         <div className="cio-detail-container">
//           <Link href="/thought-leadership" className="cio-detail-back">
//             <ArrowLeft size={18} />
...
//               <span className="cio-detail-category">THOUGHT LEADERSHIP</span>
