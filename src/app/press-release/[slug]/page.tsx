...
//   return {
//     title: item.author || 'Press Release',
//     author: meta.author,
//     date: meta.date,
...
//           return generateSlug(item.author || 'Press Release') === slug;
//         });
...
//       <main className="cio-detail-page">
//         <div className="cio-detail-container">
//           <Link href="/press-release" className="cio-detail-back">
//             <ArrowLeft size={18} />
...
//               <span className="cio-detail-category">PRESS RELEASE</span>
