...
//           return generateSlug(item.author || 'Technology') === slug;
//         });
...
//       <main className="cio-detail-page">
//         <div className="cio-detail-container">
//           <Link href="/technology" className="cio-detail-back">
//             <ArrowLeft size={18} />
//             Back to Technology
//           </Link>
...
//               <span className="cio-detail-category">TECHNOLOGY</span>
