...
// const staticPosts: OurBrandPost[] = [];
...
//     date: parts[1] || '',
//     category: parts[2]?.toUpperCase() || 'OUR BRAND',
//   };
// }
...
// function mapTestimonialsToPosts(testimonials: PageTestimonial[]): OurBrandPost[] {
//   return testimonials
//     .filter((item) => item.author || item.quote || item.avatar)
//     .map((item, index) => {
//       const meta = getRoleMeta(item.role || '');
//       const title = item.author || 'Our Brand';

//       return {
//         id: `${item.author || 'our-brand'}-${index}`,
//         title,
//         author: meta.author,
//         date: meta.date,
...
//         excerpt: cleanText(
//           item.quote ||
//             'Discover the latest brand stories, platforms, and initiatives from CIO Dialogues.',
//         ),
//         content:
//           item.quote ||
//           'Discover the latest brand stories, platforms, and initiatives from CIO Dialogues.',
...
//   const [posts, setPosts] = useState<OurBrandPost[]>(staticPosts);
...
//       try {
//         const response = await fetchWebsitePageBySlug('our-brand');
...
//         }
//       } catch (error) {
//         console.error('Failed to load our brand stories:', error);
...
//           <p>Fetching the latest brand stories.</p>
//         </section>
//       ) : !leadPost ? (
//         <section className="news-editorial-status">
//           <h2>No stories found</h2>
//           <p>No brand stories are available at the moment.</p>
//         </section>
//       ) : (
...
//             <Link href={`/our-brand/${leadPost.slug}`} className="news-editorial-left-feature">
...
//                     <Link
//                       href={item.href}
//                       className={item.href === '/our-brand' ? 'active' : undefined}
//                     >
//                       {item.label}
//                     </Link>
//                   </li>
...
//               <Link href={`/our-brand/${leadPost.slug}`}>
...
//               <Link href={`/our-brand/${leadPost.slug}`} className="news-editorial-lead-image">
//                 <Image
//                   src={leadPost.image}
//                   alt={leadPost.title}
//                   fill
...
//                 <p>
//                   Discover our communities, recognition platforms, executive initiatives, events,
//                   and enterprise technology programs.
//                 </p>

//                 {/* <Link href="/our-brand">Explore now</Link> */}
//               </div>
//             </section>
